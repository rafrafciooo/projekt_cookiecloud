			...
			<section className='bg-brand p-10 hidden w-1/2 items-center justify-center lg:flex xl:w-2/5'>
				<div className='flex max-h-[800px] max-w-[430px] flex-col justify-center'>
					...
					<Image
						...
						width={280}
						height={342}
						className='transition-all hover:scale-105 hover:rotate-3 duration-500 mt-6'
					/>
				</div>
			</section>
			<section
				className='flex flex-1 flex-col items-center bg-light-200 p-4 py-10 lg:justify-center lg:p-10 lg:py-0
'
			>
